                            ...
                            <tbody id="cartBody">
                                ...
                                {{-- @dd($item->associatedModel->sku->skuId); --}}
                                    <tr class="cartRow{{$item->associatedModel->sku->first()->skuId}}">
                                        ...
                                        <td class="product-quantity productQuantity{{$item->associatedModel->sku->first()->skuId}}" id="quantity">
                                        ...
                                        <span class="upd">
                                        <td class="product-subtotal productSubtotal{{$item->associatedModel->sku->first()->skuId}}">{{$item->price * $item->quantity}} </td>
                                        </span>

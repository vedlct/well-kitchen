    ...
    <div class="product-area pb-70">
        <div class="container">
                            ...
                            <div class="product-wrap mb-25">
                                ...
                                @endif
                                    <div class="product-action">
                                        ...
                                        <div class="pro-same-action pro-quickview">
                                            <a href="#" data-toggle="modal" data-target="#exampleModal" data-sku_id="{{ $sku->skuId }}" class="quickView"><i
                                                    class="pe-7s-look"></i></a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="text-center">
                <a href="{{route('category.products',$category->categoryId)}}" class="btn btn-secondary">View All Products</a>
            </div>
        </div>
    </div>

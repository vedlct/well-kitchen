    ...
    <div class="collections-area pt-100 pb-80">
        <div class="container">
            ...
            <div class="row">
                ...
                @foreach ($catgoriesFirstShow->take(16) as $categoryFS)
                    @if(!empty($categoryFS->imageLink))
                    <div class="col-img category_image banner-2">
                        <a href="{{route('category.products', $categoryFS->categoryId)}}" style="">
                            <img class="default-img"
                                 src="{{ asset('admin/public/categoryImage/'.$categoryFS->imageLink) }}"
                                 alt="">
                            <p style="text-align: center; margin-top: 12px; font-weight: 600;">{{$categoryFS->categoryName}} </p>
                        </a>
                    </div>
                    @endif
                @endforeach
                ...
                @foreach ($banners as $item)
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                        <div class="single-banner mb-30">
                            <a href="{{$item->pageLink}}"><img
                                    src="{{ asset('admin/public/bannerImage/' . $item->imageLink) }}"
                                    alt=""></a>
                        </div>
                    </div>

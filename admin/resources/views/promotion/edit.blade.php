                        ...
                        <div class="offset-md-1 col-md-10">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">Edit Promotion</h4>
...
{{--                                            <li><a data-action="close"><i class="ft-x"></i></a></li>--}}
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"  action="{{route('promotion.update')}}" method="POST" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <input type="hidden" class="form-control" name="promotionsId" value="{{$promotion->promotionsId}}">
                                            <div class="form-body">
                                                <div class="form-group">
                                                    <label for="companyName"><b>Promotion Title</b><span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" value="{{$promotion->promotionstitle}}" name="promotionTitle" id="promotionTitle">
                                               ...
                                               <div class="form-group">
                                                    ...
                                                    <div class='col-sm-12'>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group date" id="datetimepicker2">
                                                                <input type="text" name="startDate" id="startDate" class="form-control form_datetime" value="{{$promotion->startDate}}">
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class='col-sm-12'>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group date" id="datetimepicker2">
                                                                <input type="text" name="endDate" id="endDate" class="form-control form_datetime" value="{{$promotion->endDate}}">
                                                            </div>
                                                    ...
                                                    <div class='col-sm-12'>
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control" name="type" id="type" onchange="typeChange(this)">
                                                                ...
                                                                <option value="%" {{ old('type', $promotion->percentage ?? null) != null ? 'selected' : '' }}>%</option>
                                                                <option value="TK" {{ old('type', $promotion->percentage ?? null) == null ? 'selected' : '' }}>TK</option>
                                                            </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="{{$promotion->amount}}" name="amount" id="amount">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="{{$promotion->useLimit}}" name="limit" id="limit">

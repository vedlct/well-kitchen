                                ...
                                <div class="card-header">
                                    ...
                                    <div class="heading-elements">
                                        <ul class="list-inline mb-0">
                                            <li><a href="{{ route('category.create') }}" class="btn btn-info"><i class="ft-plus"></i>Create New</a></li>
            ...
            $('#categoryTable').DataTable({
                ...
                columns: [
                    ...
                    {title: 'Action', className: "text-center", data: function (data) {
                            return '<a title="edit" class="btn btn-warning btn-sm" data-panel-id="' + data.categoryId + '" onclick="editCategory(this)"><i class="ft-edit"></i></a>'+
                                ' <a title="delete" class="btn btn-danger btn-sm" data-panel-id="' + data.categoryId + '" onclick="deleteCategory(this)"><i class="ft-trash-2"></i></a>'
                                ;
                        },

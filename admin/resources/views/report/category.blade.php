                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Category Reports</h4>
    ...
    <script>
        $(document).ready(function () {
            ...
            dataTable = $('#categoryReportTable').DataTable({
                ...
                stateSave: true,
                "ajax":{
                    "url": "{!! route('report.categoryReport') !!}",
                    "type": "POST",
                    data:function (d){
                        d._token="{{csrf_token()}}";
                ...
                columns: [
                    {name: 'categoryId', data: 'categoryId', orderable: true, searchable: true},
                    {name: 'categoryName', data: 'categoryName', orderable: true, searchable: true},
                    {name: 'totalQuantity', data: 'totalQuantity', orderable: true, searchable: true},

! function(e, t, c) {
    ...
    function a(e) { e.element; return e.id ? "<i class='la la-" + c(e.element).data("icon") + "'></i>" + e.text : e.text }
    c(".select2").select2(), c(".select2-placeholder").select2({ placeholder: "Select a state", allowClear: !0 }), c(".select2-icons").select2({ minimumResultsForSearch: 1 / 0, templateResult: a, templateSelection: a, escapeMarkup: function(e) { return e } }), c(".select2-placeholder-multiple").select2({ placeholder: "Select State" }), c(".hide-search").select2({ minimumResultsForSearch: 1 / 0 }), c(".max-length").select2({ maximumSelectionLength: 2, placeholder: "Select maximum 2 items" });
    var s = c(".js-example-events");
    s.select2({ placeholder: "DOM Events" }), s.on("select2:open", function(e) { alert("Open Event Fired.") }), s.on("select2:close", function(e) { alert("Close Event Fired.") }), s.on("select2:select", function(e) { alert("Select Event Fired.") }), s.on("select2:unselect", function(e) { alert("Unselect Event Fired.") }), s.on("change", function(e) { alert("Change Event Fired.") });
    var l = c(".js-example-programmatic").select2(),
        r = c(".js-example-programmatic-multi").select2();
    r.select2({ placeholder: "Programmatic Events" }), c(".js-programmatic-set-val").on("click", function() { l.val("MS").trigger("change") }), c(".js-programmatic-open").on("click", function() { l.select2("open") }), c(".js-programmatic-close").on("click", function() { l.select2("close") }), c(".js-programmatic-init").on("click", function() { l.select2() }), c(".js-programmatic-destroy").on("click", function() { l.select2("destroy") }), c(".js-programmatic-multi-set-val").on("click", function() { r.val(["NM", "IN", "VA"]).trigger("change") }), c(".js-programmatic-multi-clear").on("click", function() { r.val(null).trigger("change") });

    function i(e, t) { return 0 === t.toUpperCase().indexOf(e.toUpperCase()) }

    function o(e) { return e.id ? c('<span><img src="../../../app-assets/images/flags/' + e.element.value.toLowerCase() + '.png" class="img-flag" /> ' + e.text + "</span>") : e.text }
    c(".select2-data-array").select2({ data: [{ id: 0, text: "Array Element 1" }, { id: 1, text: "Array Element 2" }, { id: 2, text: "Array Element 3" }, { id: 3, text: "Array Element 4" }, { id: 4, text: "Array Element 5" }] }), c(".select2-data-ajax").select2({
        placeholder: "Loading remote data",
        ajax: { url: "http://api.github.com/search/repositories", dataType: "json", delay: 250, data: function(e) { return { q: e.term, page: e.page } }, processResults: function(e, t) { return t.page = t.page || 1, { results: e.items, pagination: { more: 30 * t.page < e.total_count } } }, cache: !0 },
    ...
    }), c("select[data-text-color]").each(function(e, t) { var a, s = c(this).data("text-color"); "" !== (a = c(this).data("text-variation")) && (a = " " + a), c(this).next(".select2").find(".select2-selection__rendered").addClass(s + a) })

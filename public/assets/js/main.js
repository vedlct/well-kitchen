(function ($) {
  ...
  $(".productDetails-slide-active a").on("click", function () {
    $(".productDetails-slide-active a").removeClass("active");
  });
...
// category mobile menu show/hide
// show right nav
...
// select shop column area
function showTwoCol() {
  $(".shop-col-item").addClass("col-6");
  $(".shop-col-item").removeClass("col-md-3");
  $(".shop-col-item").removeClass("col-md-4");
}
function showThreeCol() {
  $(".shop-col-item").addClass("col-md-4");
  $(".shop-col-item").removeClass("col-md-3");
  $(".shop-col-item").removeClass("col-6");
}
function showFourCol() {
  $(".shop-col-item").addClass("col-md-3");
  $(".shop-col-item").removeClass("col-6");
  $(".shop-col-item").removeClass("col-md-4");
}
